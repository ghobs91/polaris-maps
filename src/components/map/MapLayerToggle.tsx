  ...
  return (
    <>
      ...
      <View style={styles.chipRow}>
        ...
        <TouchableOpacity
          style={[styles.chip, { backgroundColor: mapStyle === 'terrain' ? chipActiveBg : chipBg }]}
          onPress={() => onMapStyleChange('terrain')}
          activeOpacity={0.7}
        >
          <Ionicons
          ...
          />
          <Text style={[styles.chipLabel, { color: mapStyle === 'terrain' ? '#FFF' : textColor }]}>
            Terrain
          </Text>
        </TouchableOpacity>
      </View>
