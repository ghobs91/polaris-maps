...
const style = {
  ...
  layers: [
    ...
    // look like land instead of plain charcoal.  Water layer paints oceans
    // on top.  Transitions to neutral charcoal at city zoom (5+).
    {
      id: 'background',
      type: 'background',
      paint: {
    ...
    // continents show vegetation / desert / rock differentiation.
    // Fades to subtle semi-transparent overlays at city zoom (5+).
    {
      id: 'landcover-barren',
      type: 'fill',
      source: 'openmaptiles',
    ...
    // ───────────────────── Landuse ─────────────────────
    {
      ...
      paint: { 'fill-color': '#2A2A3E', 'fill-opacity': 0.32 },
    },
    {
      ...
      paint: { 'fill-color': '#2E2E42', 'fill-opacity': 0.32 },
    },
    {
      ...
      paint: { 'fill-color': '#26263A', 'fill-opacity': 0.3 },
    },
    {
      id: 'landuse-park',
      type: 'fill',
      ...
      paint: { 'fill-color': '#2D6A4F', 'fill-opacity': 0.56 },
    },
    {
      id: 'landuse-cemetery',
      type: 'fill',
      ...
      paint: { 'fill-color': '#2A4D3A', 'fill-opacity': 0.36 },
    },
    {
      id: 'landuse-hospital',
      type: 'fill',
      ...
      paint: { 'fill-color': '#2E2E42', 'fill-opacity': 0.3 },
    },
    {
      id: 'landuse-school',
      type: 'fill',
    ...
    },
    {
      ...
      paint: { 'fill-color': '#2D6A4F', 'fill-opacity': 0.44 },
    },
    ...
    // Park overlay (named parks from dedicated source layer)
    {
      ...
      source: 'openmaptiles',
      'source-layer': 'park',
      paint: { 'fill-color': '#2D6A4F', 'fill-opacity': 0.54 },
    },

    // ───────────────────── Water ─────────────────────
    // Deep saturated navy — stronger contrast against the olive terrain
    // background at zoomed-out levels, matching Apple Maps dark mode.
    {
      id: 'water',
      type: 'fill',
      source: 'openmaptiles',
      'source-layer': 'water',
      paint: { 'fill-color': '#2A4B6F' },
    },
    {
      id: 'waterway',
      type: 'line',
